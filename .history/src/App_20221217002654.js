...
const App = () => {
  ...
  return (
    <div> <span class="">
      ...
      <div>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded" disabled={isRecording} onClick={startRecording}><svg class="fill-current w-4 h-4 mr-2" xmlns="https://img.icons8.com/ios-glyphs/512/play.png" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>START</button>
