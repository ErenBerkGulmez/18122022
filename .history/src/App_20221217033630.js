...
const App = () => {
  ...
  useEffect( async() =>{
    await axios
        .get(`/transcript/${transcriptID}`).then((res) =>{
          setSentimentData(res.data)
        setSentiment(sentimentData.sentiment_analysis_results)
        })
  })
  ...
  return (
    <div className="Contanier">
      ...
      <h3 className="Text2">{sentimentData.sentiment_analysis_results}</h3>
    </div>  
  )
}
